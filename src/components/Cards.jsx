        ...
        <div className='w-full h-sceen bg-zinc-900 flex items-center px-32 py-10 gap-5 ' >
            ...
            <div className=" cardcontainer flex gap-10 h-[50vh] w-1/2">
                <div className="card relative w-1/2 h-full bg-[#212121] rounded-xl flex items-center justify-center">
                    ...
                    <button className='absolute left-10 bottom-10 px-5 py-1 rounded-full border-2 border-[#F1F1F1] text-[#F1F1F1]'>Rating 5.0 on Clutch</button>
                </div>
                <div className="card relative w-1/2 h-full bg-[#212121] rounded-xl flex items-center justify-center">
                    <img src="https://ochi.design/wp-content/uploads/2022/04/logo003.png" alt="" />
                    <button className='absolute left-10 bottom-10 px-5 py-1 rounded-full border-2 border-[#F1F1F1] text-[#F1F1F1]'>Business Bootcamp Alumni</button>
                </div>
            </div>
        </div>
    )
